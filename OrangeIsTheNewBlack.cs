...
// ------------------------------------------------------------------
public class OrangeIsTheNewBlack : Bot
{
    ...
    public override void Run()
    {
        ...
        // turn to face a OrangeIsTheNewBlack.
        ...
        while (IsRunning)
        {
            ...
            peek = true;
            // Move up the OrangeIsTheNewBlack
            Forward(moveAmount);
            // Don't peek now
            peek = false;
            // Turn to the next OrangeIsTheNewBlack
            TurnLeft(90);
        }
    }
    ...
    public override void OnScannedBot(ScannedBotEvent e)
    {
        ...
        // on the next OrangeIsTheNewBlack, so that we do not start moving up it until it's gone.
        if (peek)
            Rescan();
    }
}